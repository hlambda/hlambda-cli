...
metadata.command('reload').description('Reload existing metadata on the server').option('-c, --config <string>', "path to config.yaml", '').option('-s, --admin-secret <string>', "admin secret used for auth.").action(serverReload);

metadata.command('clear').description('Clear existing metadata on the server').option('-c, --config <string>', "path to config.yaml", '').option('-s, --admin-secret <string>', "admin secret used for auth.").action(serverClearMetadata);

metadata.command('apply').description('Apply metadata').option('-c, --config <string>', "path to config.yaml", '').option('-s, --admin-secret <string>', "admin secret used for auth.").action(metadataApply);

metadata.command('export').description('Export metadata').option('-c, --config <string>', "path to config.yaml", '').option('-s, --admin-secret <string>', "admin secret used for auth.").action(metadataExport);
